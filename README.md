# MattyLang
[![test](https://github.com/cntkillme/matty-lang/workflows/test/badge.svg)](https://github.com/cntkillme/matty-lang/actions)
...
- Intrinsic variables and functions ($inf, $print, $real2string)
